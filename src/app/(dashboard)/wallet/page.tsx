  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
      <header className="mb-6">
        <h1 className="text-2xl font-semibold tracking-tight sm:text-3xl">Customer Wallet</h1>
        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300">
          Placeholder MVP UI for multi-business cards and point balances.
        </p>
      </header>
      ...
      <section className="mt-6">
        <Card title="Recent Activity" description="Every points operation is auditable.">
              ...
              <li key={tx.id} className="flex items-center justify-between text-sm">
                <div>
                  ...
                  <p className="text-zinc-500 dark:text-zinc-400">
                    {new Date(tx.createdAt).toLocaleString()} · {tx.source}
                  </p>
                </div>
